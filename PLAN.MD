...
- Convert the repo into a Cargo workspace (`crates/engine`, `crates/renderer_wgpu`, `crates/app_wasm`) and add a minimal `web/` scaffold that boots WebGPU and calls into WASM per frame.
