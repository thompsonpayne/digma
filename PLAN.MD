...
## Current Progress (as of Mar 5, 2026)
...
- Rectangle tool: drag on empty canvas to create a new rect (Week 4).
- Inspector panel: x/y/w/h and fill color editable fields (Week 4).
